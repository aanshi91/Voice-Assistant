...
def get_weather(city):
    api_key = "your_actual_weather_api_key"  # Replace with your WeatherAPI key
    ...
    try:
        ...
        speak("Sorry, there was an issue with fetching the weather information.")

# Function to read the news
def get_news():
    api_key = "your_actual_newsapi_key"  # Replace with your NewsAPI key
    ...
    try:
        ...
        speak("Sorry, there was an issue with fetching the news.")
